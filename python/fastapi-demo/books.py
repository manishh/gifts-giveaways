...
def get_books_data(query: str = None):
    if query:
        q = query.casefold()
        filtered_books = [b for b in books_lst if q in b.get("title", "").casefold() or
                          q in b.get("description", "").casefold()]
    else:
        filtered_books = books_lst
